...
class DellacherieHeuristicAgent(object):
    """
    ...
    def calcDellacherieAlgo(self, env):
        # Weights from:
        # 1: https://arxiv.org/pdf/1905.01652.pdf (3.2 Hand-Crafted Agent)
        # 2: https://imake.ninja/el-tetris-an-improvement-on-pierre-dellacheries-algorithm/
        weights = np.array([-1, 1, -1, -1, -4, -1], dtype="double")
        # weights = np.array([-4.500158825082766,
        #                     3.4181268101392694,
        #                     -3.2178882868487753,
        #                     -9.348695305445199,
        #                     -7.899265427351652,
        #                     -3.3855972247263626], dtype="double")
    ...
    def predict(self, env):
        ...
        """
        return np.argmax(self.calcDellacherieAlgo(env))
